...
![security-and-privacy-firewall](./security-and-privacy-firewall.png)

### Spotlight

#### Search Results

![spotlight-search-results](./spotlight-search-results.png)
...
![notifications-do-not-disturb](./notifications-do-not-disturb.png)
...
![built-in-retina-display-color](./built-in-retina-display-color.png)
...
![built-in-retina-display-night-shift](./built-in-retina-display-night-shift.png)
...
![energy-saver-battery](./energy-saver-battery.png)
...
![energy-saver-power-adapter](./energy-saver-power-adapter.png)
...
![keyboard-keyboard](./keyboard-keyboard.png)
...
![keyboard-customize-touch-bar](./keyboard-customize-touch-bar.png)

##### Modifier Keys...

![keyboard-midifier-keys](./keyboard-midifier-keys.png)
...
###### Mission Control
 ...
 ![keyboard-shortcuts-mission-control](./keyboard-shortcuts-mission-control.png)

###### Keyboard

![keyboard-shortcuts-keyboard](./keyboard-shortcuts-keyboard.png)

###### Input Sources

![keyboard-shortcuts-input-sources](./keyboard-shortcuts-input-sources.png)

###### Screenshots

![keyboard-shortcuts-screenshots](./keyboard-shortcuts-screenshots.png)

###### Services

![keyboard-shortcuts-services](./keyboard-shortcuts-services.png)

###### Spotlight

![keyboard-shortcuts-spotlight](./keyboard-shortcuts-spotlight.png)

###### Accessibility

![keyboard-shortcuts-accessibility](./keyboard-shortcuts-accessibility.png)

###### App Shortcuts

![keyboard-shortcuts-app-shortcuts](./keyboard-shortcuts-app-shortcuts.png)

###### Function Keys

![keyboard-shortcuts-function-keys](./keyboard-shortcuts-function-keys.png)

##### Input Sources

![keyboard-input-sources](./keyboard-input-sources.png)
...
![keyboard-dictation](./keyboard-dictation.png)
...
- Look up & data detectors: false / Tap with three fingers
...
![printers-and-scanners](./printers-and-scanners.png)
...
![sound-sound-effects](./sound-sound-effects.png)
